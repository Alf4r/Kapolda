                ...
                <table class="table table-hover myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            <td>
                                <form class="border" method="POST" action="/beranda_ad/naikkanStatus/{{$laporan->id}}">
                                    @csrf

                                    <button class="btn btn-danger btn-xs btn-hapus"><i
                                            class="fa fa-trash-o">Naikkan Status</i></button>
                                </form>
                            </td>
                            <td>
                                <label for="modal-toggle-{{ $e }}" class="btn btn-primary btn-sm btn-detail">Lihat
                                    Detail</label>
