        ...
        <div class="position-absolute top-0 start-0 w-100  d-flex align-items-center"
            ...
            <fieldset style="display:flex;justify-content:center;margin-bottom: 411px;">
                <div style="display:flex;">
                    <form action="{{ url('form2/submit_lap2) }}" method="POST" style="display: flex;flex-wrap: wrap;">
                    @csrf
                        <legend
                        ...
                        <div style="display: flex;flex-wrap: wrap;flex-direction: column;">
                            ...
                            <div style="display: flex; justify-content: center; margin-top: 20px;">
                                <a href="Formulir_Laporan1.php" class="button"
                                    style="display: inline-block;padding: 10px 15px;background-color: #5955fa;color: white;text-decoration: none;border-radius: 5px;">Kembali</a>
